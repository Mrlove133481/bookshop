        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                ...
                <div class="caption font-green bold">
                    <span class="am-icon-book">添加图书</span>
                </div>
                <%--搜索--%>
                    ...
                    <div class="tpl-form-body tpl-form-line">
                        <form id="bookform" name="bookname" method="post" class="am-form tpl-form-line-form"
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <textarea class="" rows="6" id="plotsummary" placeholder="请输入内容简介"></textarea>
                                </div>
                            </div>
                            <%--作者简介--%>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <textarea class="" rows="6" id="biography" placeholder="请输入作者简介"></textarea>
                                </div>
                            </div>
                            <%--目录--%>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <textarea class="" rows="6" id="catalog" placeholder="请输入目录简介"></textarea>
                                </div>
                            </div>
                            <%--媒体评论--%>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <textarea class="" rows="6" id="mediacomments" placeholder="请输入媒体评论"></textarea>
                                </div>
                            </div>
                            <%--添加数量--%>
                            <div class="am-form-group">
